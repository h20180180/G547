...
static const PartTable def_part_table[] =
{
...
void device_setup(void)
{
	...
	device.gd = alloc_disk(3); // gendisk allocation
...
{	
	...
	printk(KERN_ALERT "dofdrive is unregistered");
...
MODULE_LICENSE("GPL");
MODULE_AUTHOR("R DEEPIKA <h20180180@goa.bits-pilani.ac.in>");
